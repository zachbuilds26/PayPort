// Creates a throwaway deployer wallet for X Layer Testnet and prints the address.
...
console.log("");
console.log("Fund it with test OKB at https://web3.okx.com/xlayer/faucet/xlayerfaucet");
